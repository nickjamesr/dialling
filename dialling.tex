...
\begin{equation}
  \theta_{i,j} \sim \sin \of{\frac{\theta_{i,j}}{2}}
  \cos \of{\frac{\theta_{i,j}}{2}}^{2 \left(i-j\right)-1} 
\end{equation}
...
operation on \(n\) qubits. This mapping is not efficient, since the number of
modes required grows exponentially with the number of qubits.
