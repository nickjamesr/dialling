...
set multiplot
  ...
  eps "beamsplitter.eps" at 25*fig_m,plot_h-8*fig_m width 8*fig_m
  eps "bsmzi.eps" at 61*fig_m,plot_h-8*fig_m width 15*fig_m
  ...
  # Component labels
  # In graphs
  text "\(r\)" at 29*fig_m,plot_h-3*fig_m
  text "\(\theta\)" at 69*fig_m,plot_h-3*fig_m
  # In Reck scheme
